interface ZPRIF_INSPECTIONLOT_CANCE_ACF8
  public .
  ...
  types:
    TY_S_INSPECTIONLOT_CANCELED_V1 TYPE STRUCTURE FOR HIERARCHY ZPR_InspectionLot_Canceled_v1 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_inspectionlot_canceled_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.