interface ZPRIF_INSPECTIONLOT_CREATED_V1
  public .
  ...
  types:
    TY_S_INSPECTIONLOT_CREATED_V1 TYPE STRUCTURE FOR HIERARCHY ZPR_InspectionLot_Created_v1 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_inspectionlot_created_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.